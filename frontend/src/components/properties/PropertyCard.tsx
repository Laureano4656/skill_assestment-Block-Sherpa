    ...
    <Link to={`/property/${id}`} className="block">
      <div className="bg-white border border-[#E6E0DA] rounded-xl overflow-hidden hover:shadow-2xl transition-all duration-300 group cursor-pointer">
        ...
        <div className="relative aspect-[340/240] overflow-hidden">
          ...
          {/* Badge */}
          {badge && (
            <div className={`absolute top-4 left-4 px-3 py-1.5 rounded text-white font-space-mono text-xs font-bold shadow-lg ${badge === 'HOT' ? 'bg-[#D4755B]' :
          ...
          >
            <span className={`material-icons text-xl transition-all ${isFavorite
                ? 'text-[#D4755B]'
